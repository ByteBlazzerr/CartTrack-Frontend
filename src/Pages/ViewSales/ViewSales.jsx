...
const ViewSales = () => {
  ...
  const getSales = async (search = '') => {
    ...
    try {
      const response = await fetch(`${baseUrl}/getsales?search=${search}`, requestOptions);
    ...
    <div className='md:w-[80%] md:mx-auto'>
      ...
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-content px-4">
          ...
          {/* search bar mobile*/}
          {/* Mobile search bar */}
          <form onSubmit={handleSearch} className='flex md:hidden items-center w-full mt-4'>
            <input 
              type="text"
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
